EZOARMORY_STRINGS_ES = {
    ...
    EZOARM_OPTION_ASSIGN_ADD = "Anadir el kit seleccionado",
    EZOARM_OPTION_ASSIGN_ADD_TOOLTIP = "Anade a este objetivo el kit seleccionado arriba en Kits guardados. Un objetivo puede tener varios kits.",
    EZOARM_OPTION_ASSIGN_REMOVE = "Quitar el kit seleccionado",
    EZOARM_OPTION_ASSIGN_REMOVE_TOOLTIP = "Quita de este objetivo el kit seleccionado arriba en Kits guardados.",
