EZOARMORY_STRINGS_ES = {
    ...
    EZOARM_BUILD_NO_BUILDS = "Todavia no hay builds. Crea una para combinar tus kits en algo que puedas equipar de una vez.",
    ...
    EZOARM_BUILD_SECTION_GEAR = "Kits de equipo",
