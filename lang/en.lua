EZOARMORY_STRINGS_EN = {
    ...
    EZOARM_OPTION_ASSIGN_ADD = "Add selected kit here",
    EZOARM_OPTION_ASSIGN_ADD_TOOLTIP = "Add the kit selected in Saved kits above to this target. A target can hold several kits.",
    EZOARM_OPTION_ASSIGN_REMOVE = "Remove selected kit",
    EZOARM_OPTION_ASSIGN_REMOVE_TOOLTIP = "Remove the kit selected in Saved kits above from this target.",
